                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Onlax Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Onlax address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and Onlax URIs)"));
    ...
    privacyAction->setStatusTip(tr("Privacy Actions for zONL"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Onlax Core"), this);
    aboutAction->setStatusTip(tr("Show information about Onlax Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Onlax"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Onlax addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Onlax addresses"));
    ...
    openAction->setStatusTip(tr("Open a Onlax URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Onlax Core help message to get a list with possible Onlax command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Onlax Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Onlax network", "", count));
}
...
void BitcoinGUI::setNumBlocks(int count)
{
    ...
    case BLOCK_SOURCE_NETWORK:
        progressBarLabel->setText(tr("Synchronizing with Onlax network..."));
        break;
...
{
    QString strTitle = tr("Onlax Core"); // default title
