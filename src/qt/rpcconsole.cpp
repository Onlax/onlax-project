...
void RPCConsole::walletResync()
{
    ...
    QMessageBox::StandardButton retval = QMessageBox::question(this, tr("Confirm resync Onlax Blockchain"),
        resyncWarning,
...
void RPCConsole::clear()
{
    ...
    message(CMD_REPLY, (tr("Welcome to the Onlax RPC console.") + "<br>" +
