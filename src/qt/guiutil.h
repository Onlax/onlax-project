...
/** Utility functions used by the Onlax Qt UI.
 */
namespace GUIUtil
{
...
// Render Onlax addresses in monospace font
...
// Parse "onlax:" URI into recipient object, return true on successful parsing
