...
static bool AppInitRPC(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help") || mapArgs.count("-version")) {
        std::string strUsage = _("Onlax Core RPC client version") + " " + FormatFullVersion() + "\n";
        if (!mapArgs.count("-version")) {
            strUsage += "\n" + _("Usage:") + "\n" +
                        "  onlax-cli [options] <command> [params]  " + _("Send command to Onlax Core") + "\n" +
                        "  onlax-cli [options] help                " + _("List commands") + "\n" +
                        "  onlax-cli [options] help <command>      " + _("Get help for a command") + "\n";
