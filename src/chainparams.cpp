...
static Checkpoints::MapCheckpoints mapCheckpoints =
	...
	(0, uint256("0x0000070bcc0c45447cbe5a220b3080597053b1c2f6706ea2994d6852b57f1041"));

static const Checkpoints::CCheckpointData data = {
    &mapCheckpoints,
    1522523324, // * UNIX timestamp of last checkpoint block
...
public:
	...
	nMaxMoneyOut = 10000000000 * COIN;
        ...
        nZerocoinStartTime = 1533340800; // Saturday, 04-Aug-18 00:00:00 UTC
	nZerocoinStartHeight = 129601;
		
	const char* pszTimestamp = "Today is a really good day to start! Onlax Core team 02-04-2018";
        ...
        txNew.vout[0].scriptPubKey = CScript() << ParseHex("043d9905c6efff2f7ab385bc7ac4dc8651d548f7200f07663afd284e80dea99fbcad44ea653d4038ddf61a15b48da715ecfb1cf9fbdeca9da37730da1077f6b93b") << OP_CHECKSIG;
        genesis.vtx.push_back(txNew);
        genesis.hashPrevBlock = 0;
        genesis.hashMerkleRoot = genesis.BuildMerkleTree();
        genesis.nVersion = 1;
        genesis.nTime = 1522523324;
	...
	vFixedSeeds.clear();
        ...
        vSeeds.push_back(CDNSSeedData("onlaxhead.ddns.net", "onlaxhead.ddns.net"));
	...
	strSporkKey = "033d9905c6efff2f7ab385bc7ac4dc8651d548f7200f07663afd284e80dea99fbc";
