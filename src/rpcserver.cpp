...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Onlax features */
        {"onlax", "masternode", &masternode, true, true, false},
        {"onlax", "listmasternodes", &listmasternodes, true, true, false},
        {"onlax", "getmasternodecount", &getmasternodecount, true, true, false},
        {"onlax", "masternodeconnect", &masternodeconnect, true, true, false},
        {"onlax", "masternodecurrent", &masternodecurrent, true, true, false},
        {"onlax", "masternodedebug", &masternodedebug, true, true, false},
        {"onlax", "startmasternode", &startmasternode, true, true, false},
        {"onlax", "createmasternodekey", &createmasternodekey, true, true, false},
        {"onlax", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"onlax", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"onlax", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"onlax", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"onlax", "getmasternodescores", &getmasternodescores, true, true, false},
        {"onlax", "mnbudget", &mnbudget, true, true, false},
        {"onlax", "preparebudget", &preparebudget, true, true, false},
        {"onlax", "submitbudget", &submitbudget, true, true, false},
        {"onlax", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"onlax", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"onlax", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"onlax", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"onlax", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"onlax", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"onlax", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"onlax", "checkbudgets", &checkbudgets, true, true, false},
        {"onlax", "mnsync", &mnsync, true, true, false},
        {"onlax", "spork", &spork, true, true, false},
        {"onlax", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"onlax", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use onlaxd, or the -server option to onlax-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> onlax-cli " + methodname + " " + args + "\n";
}
