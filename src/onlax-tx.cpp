...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Onlax Core onlax-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  onlax-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded onlax transaction") + "\n" +
                               "  onlax-tx [options] -create [commands]   " + _("Create hex-encoded onlax transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded onlax transaction
