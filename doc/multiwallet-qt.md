...
In order to support loading of multiple wallets in Onlax-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is Onlax.cpp.
...
Changes to Onlax.cpp
----------------------
Onlax.cpp is the entry point into Onlax-qt, and as such, will require some minor modifications to provide hooks for
