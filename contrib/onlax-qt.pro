...
RESOURCES += src/qt/onlax.qrc src/qt/onlax_locale.qrc

TRANSLATIONS += src/qt/locale/onlax_bg.ts \
                src/qt/locale/onlax_de.ts \
                src/qt/locale/onlax_en.ts \
                src/qt/locale/onlax_es.ts \
                src/qt/locale/onlax_fi.ts \
                src/qt/locale/onlax_fr.ts \
                src/qt/locale/onlax_it.ts \
                src/qt/locale/onlax_ja.ts \
                src/qt/locale/onlax_pl.ts \
                src/qt/locale/onlax_pt.ts \
                src/qt/locale/onlax_ru.ts \
                src/qt/locale/onlax_sk.ts \
                src/qt/locale/onlax_sv.ts \
                src/qt/locale/onlax_vi.ts \
                src/qt/locale/onlax_zh_CN.ts \
                src/qt/locale/onlax_zh_TW.ts
