Contributing to Onlax Core
============================

The Onlax Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Onlax Core project, and is not to be
confused with overall Onlax Network Protocol consensus changes.

Whether a pull request is merged into Onlax Core rests with the project merge
...
Patches that change Onlax consensus rules are considerably more involved than
...
Where a patch set proposes to change the Onlax consensus, it must have been
...
The project leader is the release manager for each Onlax Core release.
